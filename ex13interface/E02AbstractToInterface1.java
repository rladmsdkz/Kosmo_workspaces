...
abstract class PersonalNumberStorageAbs { //Abs = abstract 의미
	/*
	해당 클래스는 추상메서드를 포함하고 있으므로 상속받게되면
	하위 클래스에서는 반드시 추상메서드를 오버라이딩 해야 한다. 
	 */
	public abstract void addPerosnalInfo (String juminNum, String name);
...
class PersonalInfoDTO  {
	...
	/*
	getter / setter 메서드: DTO객체에서 private으로 선언된 멤버변수의 값을
		설정하거나 반환할때 사용한다. 
	 */
...
class PersonalNumberStorageExt extends PersonalNumberStorageAbs {
	 ...
	 */
	@Override 
	public void addPerosnalInfo (String juminNum, String name) {
		personalArr[numOfPerInfo] = new PersonalInfoDTO(name, juminNum);
		numOfPerInfo++; 
	}
	/*
	주민번호를 매개변수로 받은 후 객체배열에 일치하는 정보가 있는지 
...
public class E02AbstractToInterface1 {
	...
	public static void main(String[] args) {
		...
		//2개의 정보를 추가 
		storage.addPerosnalInfo("901234-2222222", "김태희");
		storage.addPerosnalInfo("901234-1111111", "정지훈");
