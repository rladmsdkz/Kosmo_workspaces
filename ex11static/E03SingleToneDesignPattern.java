...
작성방법
	...
	2. 클래스 외부에서는 생성자를 접근할 수 없으므로 new 를 
		통해 객체생성은 할 수 없다. 
...
//		SingleTone st1 = new SingleTone(); //에러발생
		...
		//마지막에 할당된 값이 출력된다. 
		System.out.println(String.format("st2의 주소:%s", st2.shareVar));
		System.out.println(String.format("st3의 주소:%s", st3.shareVar));
	}
