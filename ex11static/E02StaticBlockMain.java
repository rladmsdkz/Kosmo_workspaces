...
static 블럭 
	...
	또한 생성자 메서드보다도 static 블럭이 먼저 실행된다. 
 */
...
public class E02StaticBlockMain {
	...
	static {
		...
		//static 블럭내에서는 인스턴스형 멤버는 접근할 수 없다. 
...
//		instanceMethod();
	...
	public static void main(String[] args) {
		...
		//메인메서드 실행전에 static 블럭이 먼저 실행된다. 
		System.out.println("==메인메소드==");
		/*
		static 블럭 내에서 선언된 변수는 지역변수이므로, main 메서드에서는
