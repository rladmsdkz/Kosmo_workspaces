...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("arr[3]의 원소 출력:"+ arr2[3]); // 크기 지정하면 0으로 채워짐. 
		
		/*
		2차원 배열에서 배열명.length로 세로크기 즉 행의 크기를 알 수 있다. 
		 */
		...
		for(int i=0 ; i<arr.length ; i++) {
			//2차원 배열에서 행의 크기를 알고 싶을때 "배열명[인덱스]"로 기술한다. 
		...
		System.out.println("arr[0][3]="+arr[0][3]); //예외발생 (null이므로 출력할 수 없다.)
		/*
