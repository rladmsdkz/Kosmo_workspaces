...
/*
 배열: 순차적인 메모리의 공간이 할당되는 형태의 형태로써 
...
public class E01OneDimArray01 {
	...
	System.out.println("numArr 2번방의 값:"+ numArr[0]);
	System.out.println("numArr 2번방의 값:"+ numArr[1]);
	System.out.println("numArr 2번방의 값:"+ numArr[2]);
	//정수형 배열이 Heap영역에 생성된후 반환된 주소값이 출력된다. 
	...
	int [] initArr3 = {11, 13, 17, 19, 23}; //원소의 갯수를 통해 크기 5로 지정됨. 
	int arrSum = 0;
