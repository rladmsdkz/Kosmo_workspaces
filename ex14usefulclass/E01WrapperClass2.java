...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		parseDoouble(): 실수로 변경한다. 
		 */
		String strNumber = "1000";
		System.out.println("10+strNumber="+ (10+strNumber)); //숫자+문자열 => 101000
		System.out.println("10+strNumber를 숫자로 변경:"+ (10+Integer.parseInt(strNumber)));//숫자+숫자 =>1010
		System.out.println("10+strNumber를 숫자로 변경:"+ (10+Integer.valueOf(strNumber)));//숫자+숫자 =>1010
...
//		System.out.println(Integer.parseInt(floatString)); //예외발생
		...
		/*
		isWhilespace() : 공백문자인지 판단하는 메서드. 공백문자일때 true를
			반환한다. 
		 */
