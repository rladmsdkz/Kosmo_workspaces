...
Wrapper클래스
	...
	클래스로 Unboxing을 통해 기본자료형의 데이터를 객체화한다. 
 */
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * JDK1.4 이전의 코딩형태 기본자료형을 박싱 처리한 객체에 대해서 산술연산을 진행할때는 
		  	다시 언박싱을 위해 intValue()와 같은
		 * 메서드를 호출해야 한다.
		 */
		Integer n10Obj = new Integer(10);// 현재는 이와 같은 생성자는
		Integer n20Obj = new Integer(num2);// deprecated(디프리케이트) 되었다.
		// 구 번전과의 호환성을 위해 아직은 남겨놓은 상태이다
		...
		System.out.println("10을 16진수로:" + Integer.toHexString(result3));
	}
