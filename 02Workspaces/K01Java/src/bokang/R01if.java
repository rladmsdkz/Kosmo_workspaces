...
public class R01if {
	...
	public static void main(String[] args) {
		...
		int num2 = 200;
		/*
		if문: 조건식이 참일때 블럭을 수행하는 구조를 가지고 있다. 
		...
		//위 문장을 if~else 몬으로 변경하면...
		if(num1>num2) {
			//조건식이 true일때 해당 문장 실행
			System.out.println("num1이 num2보다 크다.");
		}
		else {
			//조건식이 false일때 else 블럭의 문장 실행
			System.out.println("num2가 num1보다 크다.");
		}
		
		
		/*
		만약 2개이상의 조건을 사용하고 싶다면 아래와 같이 else구문에는 
...
//		}
		...
		case 10: case 11:
			...
			break;
		/*
		위에서 정의한 3블럭의 case문으로 가을까지의 계절을 판단하였으므로
		나머지는 별도의 case문이 없어도 겨울로 판단할 수 있다.
		따라서 else문과 동일한 역할의 default문을 사용하는것도 좋다.	
		 */
