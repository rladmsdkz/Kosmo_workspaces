 ...
 */
	...
	public static void main(String[] args) {
		...
		if(avg>=90) {
			...
			System.out.println("F학점. 학사경고 ㅠㅠ;");
		}
		
		/*
		if~else 구문을 구성할때는 조건의 구간을 어떻게 설정하느냐에 따라 전혀 
		다른 결과가 나올 수 있다. 
		...
		else if (avg>=80) {//현재 평균값은 77.6xxx이므로 C학점 출력
			System.out.println("B학점");
		}
		else if (avg>=90) {
			System.out.println("A학점");
		...
		else if (avg>=80 && avg<90) {//현재 평균값은 77.6xxx이므로 C학점 출력
			System.out.println("B학점");
		}
		else if (avg>=90) {
			System.out.println("A학점");
