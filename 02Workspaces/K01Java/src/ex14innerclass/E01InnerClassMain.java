...
-외부 클래스의 모든 멤버(정적 혹은 인스터스형)를 사용할 수 있다.
-정적 멤버를 가질 수 없다.
...
class Unit {
	...
	//인스턴스형 멤버변수: 사용시 반드시 new를 통해 객체를 생성해야 한다. 
	Marine marine;
	Medic medic;
	...
	public String infoStr() {
		return "유닛정도[이름:"+name+", 체력:"+healthPoint+"]";
	}
...
public class E01InnerClassMain {
	...
	public static void main(String[] args) {
		...
		Marine은 Unit클래스의 생성자에서 이미 객체가 생성되었으므로 아래와 같이
		즉시 객체를 생성할 수 있다.
		 */
		...
		아래와 같이 new를 통해서 생성해야 한다. 이때에도 Unit객체를 통해 생성해야
