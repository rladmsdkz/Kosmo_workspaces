...
형식]
	...
	개념을 이해하면된다. 상속되기 대문에 오버라이딩이 가능하다.
	즉, {} 안쪽은 "자식"의 영역이다. 
 */
...
interface ISinger {
	/*
	인터페이스는 기능이 없는 추상메서드만 멤버로 가질 수 있다.
...
public class E02AnonymousClass {
	...
	public static void main(String[] args) {
		...
		: Singer타입의 변수에 GirlGroup 을 상속받은 익명클래스를 생성해서 그
		주소를 할당한다.
		개념적으로 new GirlGroup (){}; ==> 익명 extends GirlGrouop (); 형태로
		생각하면 된다.
