...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		/*
		-동일한 타입의 변수를 2개이상 선언할 경우 ,(콤마)를 사용할 수 있다. 
		-int형보다 작은 자료형을 연산하면 CPU는 int형으로 변환하여 연산한다. 
		-CPU가 int형의 연산에 최적화 되어 있기 때문이다. 
		-byte, short형은 게임케릭터의 움직임이나 음원정보등을 표현할때 주로 사용된다. 
		 */
		...
		-단, byte형과 short형은 예외적인 상황으로 생각하면 된다. int형에 최적화된 
		CPU의 특성 때문이다. 
		 */
