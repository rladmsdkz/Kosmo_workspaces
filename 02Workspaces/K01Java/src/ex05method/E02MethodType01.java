...
/*
 ...
 규칙
 	...
 	-메서드안에 또 다른 메서드를 정의할 수 없다. (기능에 대한 최소단위)
...
public class E02MethodType01 {
	...
	static void noParamNoReturn() {
		...
		System.out.println("1.열기, 2.계확하기, 3.종료");
		System.out.println("======================");
	}
	...
	static void noParamNoReturn3 () {
		...
		/*
		위와 같은 메서드 중간에 return을 기술하면 함수가 즉시 종료되므로 
		그 아래 코드는 실행되지 않는 쓰래기코드가 된다. 
		따라서 return을 사용할대는 반드시 조건문과 함께 써야한다. 
