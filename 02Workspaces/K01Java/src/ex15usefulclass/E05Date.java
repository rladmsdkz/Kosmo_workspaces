...
public class E05Date {
	...
	/*
	Calendar 클래스를 통해 얻은 객체를 초로 변환한 후 매개변수로 전달된
	...
	public static void main(String[] args) {
		...
		//여러가지 서식 사용하기
		/*
		월을 표현하는 Month, 분을 표현하는 Minute의 이니셜이 동일하기 때문에
		구분을 위해 월은 대문자, 분은 소문자로 표현한다. 
		 */
		String nowStr1 = myDateFormat(calendar, "yyy-MM-dd HH:mm:ss");
		...
		calendar.add(Calendar.YEAR, 1); //1년
