...
class MyClass {
	...
	객체가 가진 멤버변수의 값에대한 비교를 통해 동일여부를 판단한다. 
	 */
	//equals메서드의 매개변수 타입은 모든 객체를 대상으로 하므로 Object 형으로 
	//정의되어 있다. 
	@Override
	public boolean equals (Object obj) {
		...
		if(obj instanceof MyClass) {
			/*
			매개변수가 MyClass타입이 맞다면 비교를 위해 다운캐스팅 한다. 
			...
			/*
			메게변수로 전달된 객체가 MyClass의 인스턴스가 아니라면
