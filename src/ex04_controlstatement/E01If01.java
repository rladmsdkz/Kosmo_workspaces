...
if문 (조건문) 형식1
	...
	-즉, 결과값이 boolean형으로 true or false를 반환해야 한다. 
...
//		}
		...
		if(num%2 == 0) {
			//특정한 수를 2로 나눠서 나머지가 0이라면 짝수로 판단할 수 있다. 
		...
		//경우에 따라 무조건 실행되는 if문도 필요한 경우가 있다. 
		if(true) {
		...
		if(num%2 !=0) {
			System.out.println("num은"+ num + "은 짝수이다");
		...
		/*
		아스키코드를 알고 있을때 구현방법
		0은 48, 9는 57 이므로 해당 구간안에 있다면 숫자로 판단한다. 
		*/
