...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		 ...
		 */
		int num1=10, num2=20;
		String numResult = (num1==num2) ? "데이터가같다" : "데이터가다른다";
		...
		단순한 참조값(주소값)에 대한 비교를 하게된다. 2개의 객체는 
		따로 생성되므로 참조주소는 다르다는 결과가 출력된다. 
		 */
		if(str1==str2) {
		...
		if(str1.equals(str2)) {
			System.out.println("두 문자열은 동일하다");//여기출력됨. 
		}
		else {
		...
		String 클래스의 객체 생성 방법2
			...
			따라서 String 객체는 주로 방법2를 이용하는것이 좋다.
		 */
		String str3 = "KOSMO";
		String str4= "KOSMO";
