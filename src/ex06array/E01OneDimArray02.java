...
public class E01OneDimArray02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("생성된 난수:"+ random.nextInt()); //음수, 양수의 정수가 생성됨. 
		System.out.println("================================");
		
		/*
		로또번호처럼 1~45사이의 난수를 생성하는 방법
		1. 0.xxxx형태의 난수를 생성한 후 정수로 변경하기 위해 100을 곱하고 
		2. 45로 %연산하여 나머지를 구한다. 모든 정수는 45로 나누면 나머지가 
			0~44까지만 나오게 된다. 
		3. 0은 구간에 포함되면 안되므로 2번의 결과에 1을 더한다. 
			결과적으로 1~45사이의 난수를 생성할 수 있다. 
		4. 마지막에 정수의 결과를 얻기 위해 int로 강제 형변환 한다.
		 */
		
		System.out.println("1~45사이의 난수생성:"+ 
					((int)((Math.random()*100) % 45)+1)); //Math.random()자체가 실수임. 
