...
//	void myFunc() {
//		System.out.println("나는 정의할 수없는 클래스");
//	}
//}
...
/*
public 클래스는 해당 java 파일을 대표하는 클래스로 파일명과 동일해야 하고 
다른 패키지에서도 접근할 수 있다. public 클래스는 하나의 자바 파일에 단 하나만
정의할 수 있다. 
...
public class E01AccessModifier1 {
	...
	private void privateMethod() {
		privateVar = 100;//사용가능 
		System.out.println("privatedMethod() 메소드 호출");
	}
	void defaultMethod() {
		privateVar = 200;//사용가능 
