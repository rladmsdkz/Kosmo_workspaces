...
class MyFriendDetailInfo extends MyFriendInfo {
	private String addr;
  	...
  	/*
  	자식 클래스는 부모 클래스의 객체를 먼저 생성해야할 책임이 있으므로
  	항상 부모클래스의 멤버변수를 초기화하기 위한 인수까지 던달받아야 한다. 
...
class QuMyFriendDetailInfo {
	...
	public static void main(String[] args) {
		...
		MyFriendDetailInfo myFriendDetails = new MyFriendDetailInfo("이순신", 100, "성균관", "010-1000-8888");
		myFriendDetails.showMyFriendDetailInfo();
