...
public class E07RideAndLoad02 {
	...
	public static void main(String[] args) {
		...
		DeChild child = new DeChild("율곡아이", 49 , "00학번");
		...
		자식쪽 메서드가 호출된다.
		자식객체가 메모리에 생성될때 부모쪽의 메서드가 가려지기 
		때문에 참조벼수의 영향을 전혀 받지 않는다. 
		 */
		parent.exercise();
		parent.sleep();
		parent.printParent();
		 ...
		 */
//		parent.study(); //에러발생 (undefined method: 정의되지 않음)
		parent.walk();
//		parent.walk(20); //에러발생
