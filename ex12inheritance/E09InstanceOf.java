...
instanceof 연산자
	...
	전달된 인수가 기존에 어떤 타입이었는지 확인할대 사용한다. 
 */
...
public class E09InstanceOf {
	...
	따라서 부모로 자식을 참조할 수 있는은 우리에게  편리함을 가져다준다. 
	 */
...
//	static void wrapBox (GoldPaperBox b) {}
	...
	전달된 매개변수를 최상위 클래스인 Box 타입으로 받고 있기 때문이다. 
	-Box 타입으로 인수를 받게되면 자동 형변환 (업케스팅) 되므로 
