...
가변인자 (Variable Argument)
	...
	-필요에 따라 매개변수를 가변적으로 조장할 수 있는 문법
	-매개변수를 2개이상 받을 수 있어야 하므로 배열로 반환한다. 
	-단, 자료형은 모두 동일해야 한다. 
 */
...
//	}
	...
	/*
	...을 통해 매개변수 param 이 2개이상의 인수를 받을 수 있는것을
	명시한다. 또한 메서드 내에서는 배열로 반환되어 "매개변수명.length와 
	같이 사용할 수 있다. 
	 */
	...
	public static void main(String[] args) {
		...
		double로 해주면 된다. 
		 */
		//System.out.println("getTotal(args1,agrs2)호출:"+  getTotal(10, 20.3));
	}
